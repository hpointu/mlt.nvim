local _0_0 = nil
do
  local name_0_ = "more-like-that.aniseed.compile"
...
local function _2_(...)
  _0_0["aniseed/local-fns"] = {require = {a = "more-like-that.aniseed.core", fennel = "more-like-that.aniseed.fennel", fs = "more-like-that.aniseed.fs", nvim = "more-like-that.aniseed.nvim"}}
  return {require("more-like-that.aniseed.core"), require("more-like-that.aniseed.fennel"), require("more-like-that.aniseed.fs"), require("more-like-that.aniseed.nvim")}
end
local _1_ = _2_(...)
local a = _1_[1]
local fennel = _1_[2]
...
do
  ...
  do
    ...
    local function macros_prefix0(code)
      local macros_module = "more-like-that.aniseed.macros"
