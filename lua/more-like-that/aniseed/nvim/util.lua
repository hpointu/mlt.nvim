local _0_0 = nil
do
  local name_0_ = "more-like-that.aniseed.nvim.util"
...
local function _2_(...)
  _0_0["aniseed/local-fns"] = {require = {nvim = "more-like-that.aniseed.nvim"}}
  return {require("more-like-that.aniseed.nvim")}
end
local _1_ = _2_(...)
local nvim = _1_[1]
